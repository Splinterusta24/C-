...
namespace Dbfirst.Model
{
    ...
    public partial class NortwindEntities : DbContext
    {
        ...
        public virtual DbSet<MusteriBilgisi> MusteriBilgisi { get; set; }
        ...
        public virtual int addship(Nullable<decimal> price)
        {
            var priceParameter = price.HasValue ?
                new ObjectParameter("price", price) :
                new ObjectParameter("price", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("addship", priceParameter);
        }
        ...
        public virtual ObjectResult<letter_Result> letter(string letters)
        {
            var lettersParameter = letters != null ?
                new ObjectParameter("letters", letters) :
                new ObjectParameter("letters", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<letter_Result>("letter", lettersParameter);
        }
